...
contract MerklizedERC20 is Context, IERC20, IERC20Metadata {
    ...
    function transferTo(
        ...
        _transfer(msg.sender, recipient, amount, proof0, proof1);
        return true;
    }
    ...
    function _updateBalance(
        ...
        uint256 _idx1 = _indices1[addr];
        if (_idx1 == 0) {
            TreeNode memory node = TreeNode({addr: addr, balance: newAmount});
    ...
    function _transfer(
        ...
        unchecked {
            _updateBalance(sender, senderBalance - amount, proof0);
        }
        _updateBalance(recipient, _balances[recipient] + amount, proof1);
    ...
    function _mint(
        ...
        _totalSupply += amount;
        _updateBalance(account, _balances[account] + amount, proof);
