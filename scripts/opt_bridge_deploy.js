...
requireEnvVariables(["DEVNET_PRIVKEY", "L2RPC", "L1RPC", "MESSENGER_ADDR"]);
...
const main = async () => {
  ...
  const L2BridgeDst = await (
    await hre.ethers.getContractFactory("OptimismBridgeDestination")
  ).connect(l2Signer);
